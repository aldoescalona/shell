...
cd /opt/respaldos
 ...
 mysqldump -u root -proot --skip-comments --default-character-set=UTF8 --skip-lock-tables --skip-triggers --skip-add-drop-table --no-create-info risto _sequences parametro | sed -e '1s/^/\nUSE risto;\n/' > /var/mirror/dump/dristo.1.0.20.sql
